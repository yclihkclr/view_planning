...
viewpoint_6Ds = [(np.array([-0.03439183,  0.70912371,  0.02172246]), array([[ 0.99861581,  0.        ,  0.05259716],
       [ 0.00241911, -0.99894175, -0.0459296 ],
       [ 0.0525415 ,  0.04599326, -0.99755903]])), (np.array([ 0.44560817,  0.80912371, -0.07827754]), array([[ 0.94416368,  0.        , -0.32947676],
       [-0.11487248, -0.93725254, -0.32918382],
       [-0.30880293,  0.34865122, -0.88491981]])), (np.array([-0.51439183,  0.48912371, -0.13827754]), array([[ 0.79984612,  0.        ,  0.60020512],
       [-0.17331395, -0.95740216,  0.23096186],
       [ 0.57463768, -0.28875786, -0.7657744 ]])), (np.array([-0.19439183,  1.22912371, -0.53827754]), array([[ 0.98971321,  0.        , -0.14306558],
       [-0.14289199, -0.04924652, -0.98851235],
       [-0.00704548,  0.99878665, -0.04873993]])), (np.array([-0.71439183,  0.44912371, -0.45827754]), array([[ 0.44913151,  0.        ,  0.89346566],
       [-0.60660424, -0.73419928,  0.30493067],
       [ 0.65598184, -0.67893403, -0.32975203]])), (np.array([ 0.62560817,  0.80912371, -0.13827754]), array([[ 0.87191406,  0.        , -0.48965893],
       [-0.17258234, -0.93582907, -0.30730976],
       [-0.45823706,  0.35245419, -0.81596252]])), (np.array([-0.13439183,  0.56912371, -0.95827754]), array([[ 0.99125138,  0.        , -0.13198754],
       [ 0.03290894,  0.96841764,  0.24715233],
       [ 0.12781906, -0.24933366,  0.95994532]])), (np.array([-0.77439183,  0.66912371, -0.81827754]), array([[ 0.24381952,  0.        ,  0.96982062],
       [-0.25962426,  0.96350137,  0.06527131],
       [-0.9344235 , -0.26770339,  0.23492045]])), (np.array([-0.57439183,  1.04912371, -0.29827754]), array([[ 0.79436209,  0.        ,  0.60744454],
       [ 0.47357621, -0.62625227, -0.61930095],
       [ 0.38041353,  0.77962048, -0.49747106]])), (np.array([ 0.08560817,  0.32912371, -0.79827754]), array([[ 0.99993805,  0.        , -0.01113061],
       [ 0.00539718,  0.87457206,  0.48486552],
       [ 0.00973452, -0.48489556,  0.87451789]])), (np.array([ 0.38560817,  1.00912371, -0.11827754]), array([[ 0.97389658,  0.        , -0.22699218],
       [-0.12836811, -0.8247361 , -0.55075585],
       [-0.18720864,  0.56551779, -0.80320766]])), (np.array([ 0.00560817,  1.06912371, -0.77827754]), array([[ 0.97668352, -0.        , -0.21468421],
       [-0.12359476,  0.81765754, -0.5622815 ],
       [ 0.17553816,  0.57570492,  0.79859264]])), (np.array([-0.51439183,  0.86912371, -0.07827754]), array([[ 0.90977134,  0.        ,  0.41510976],
       [ 0.11619289, -0.96002659, -0.25465303],
       [ 0.3985164 ,  0.27990883, -0.87340467]])), (np.array([-0.17439183,  0.48912371,  0.00172246]), array([[ 0.97454658,  0.        ,  0.22418511],
       [-0.06019859, -0.96327361,  0.26168701],
       [ 0.2159516 , -0.26852181, -0.938755  ]])), (np.array([0.32560817, 0.72912371, 0.00172246]), array([[ 0.97499243,  0.        , -0.22223809],
       [-0.04960052, -0.97477578, -0.21760507],
       [-0.21663231,  0.22318642, -0.950399  ]])), (np.array([-0.61439183,  0.40912371, -0.65827754]), array([[ 0.86881947,  0.        ,  0.495129  ],
       [-0.49512136, -0.00555366,  0.86880607],
       [ 0.00274978, -0.99998458, -0.00482512]])), (np.array([-0.19439183,  1.10912371, -0.23827754]), array([[ 0.99364418,  0.        , -0.11256665],
       [-0.08076923, -0.69653417, -0.71296317],
       [-0.07840652,  0.71752362, -0.69210713]])), (np.array([-0.27439183,  0.22912371, -0.45827754]), array([[ 9.87699712e-01,  0.00000000e+00,  1.56362651e-01],
       [-1.56362030e-01,  2.81792719e-03,  9.87695791e-01],
       [-4.40618566e-04, -9.99996030e-01,  2.78326588e-03]])), (np.array([ 0.70560817,  0.92912371, -0.25827754]), array([[ 0.79534934,  0.        , -0.60615132],
       [-0.34423255, -0.82309846, -0.45167785],
       [-0.49892222,  0.5678987 , -0.65465082]])), (np.array([-0.23439183,  0.96912371, -0.83827754]), array([[ 0.98486336, -0.        ,  0.17333253],
       [ 0.06400521,  0.92932511, -0.36367318],
       [-0.16108227,  0.36926257,  0.91525824]])), (np.array([-0.27439183,  0.74912371, -0.01827754]), array([[ 0.91898058,  0.        ,  0.3943028 ],
       [ 0.01738299, -0.99902777, -0.04051361],
       [ 0.39391944,  0.04408538, -0.91808712]])), (np.array([ 0.02560817,  0.94912371, -0.85827754]), array([[ 0.97912536, -0.        , -0.2032573 ],
       [-0.05677816,  0.96019187, -0.27351016],
       [ 0.195166  ,  0.27934131,  0.94014821]])), (np.array([-0.65439183,  0.42912371, -0.35827754]), array([[ 0.52433846,  0.        ,  0.85150994],
       [-0.53260646, -0.78023642,  0.32796569],
       [ 0.66437907, -0.62548472, -0.40910796]])), (np.array([-0.67439183,  0.62912371, -0.99827754]), array([[ 0.60948218,  0.        ,  0.79279977],
       [-0.21916675,  0.9610293 ,  0.16848924],
       [-0.7619038 , -0.27644654,  0.58573024]])), (np.array([-0.03439183,  0.96912371, -0.07827754]), array([[ 0.99479387,  0.        , -0.10190762],
       [-0.05389037, -0.84873656, -0.52606281],
       [-0.08649272,  0.5288159 , -0.84431792]])), (np.array([-0.41439183,  1.08912371, -0.23827754]), array([[ 0.97011664,  0.        ,  0.24263903],
       [ 0.174009  , -0.69691708, -0.69572082],
       [ 0.16909929,  0.71715172, -0.67609086]])), (np.array([ 0.20560817,  0.98912371, -0.09827754]), array([[ 0.99997837,  0.        ,  0.00657752],
       [ 0.00328949, -0.86596182, -0.50009929],
       [ 0.00569589,  0.50011011, -0.86594309]])), (np.array([-0.09439183,  0.42912371, -0.07827754]), array([[ 0.99856478,  0.        ,  0.05355735],
       [-0.02545456, -0.87983641,  0.47459452],
       [ 0.04712171, -0.47527665, -0.87857365]])), (np.array([ 0.72560817,  0.60912371, -0.13827754]), array([[ 0.79585045,  0.        , -0.60549324],
       [-0.05566836, -0.99576465, -0.07316959],
       [-0.60292877,  0.09193887, -0.79247974]])), (np.array([-0.25439183,  0.80912371, -0.05827754]), array([[ 0.96543008,  0.        ,  0.26066215],
       [ 0.09011628, -0.93833749, -0.33376911],
       [ 0.24458906,  0.34572064, -0.90589924]])), (np.array([ 0.00560817,  0.88912371, -0.03827754]), array([[ 0.9999342 ,  0.        , -0.01147177],
       [-0.00436542, -0.92476621, -0.38051072],
       [-0.01060871,  0.38053576, -0.92470536]])), (np.array([-0.41439183,  0.66912371, -0.11827754]), array([[ 0.91188133,  0.        ,  0.41045395],
       [ 0.03204392, -0.99694792, -0.07119008],
       [ 0.40920121,  0.07806945, -0.9090982 ]])), (np.array([-0.23439183,  0.66912371, -0.05827754]), array([[ 0.92721031,  0.        ,  0.3745411 ],
       [-0.01687107, -0.99898497,  0.04176586],
       [ 0.37416093, -0.04504464, -0.92626917]])), (np.array([ 0.18560817,  0.94912371, -0.03827754]), array([[ 0.99830767,  0.        , -0.05815315],
       [-0.02480831, -0.90443896, -0.4258811 ],
       [-0.05259598,  0.42660305, -0.90290836]])), (np.array([-0.17439183,  0.54912371, -0.93827754]), array([[ 0.9941684 ,  0.        , -0.10783873],
       [ 0.03937449,  0.93095898,  0.36299454],
       [ 0.10039344, -0.36512379,  0.92553   ]])), (np.array([-0.25439183,  0.58912371, -0.05827754]), array([[ 0.9147277 ,  0.        ,  0.40407083],
       [-0.08261035, -0.97887801,  0.1870117 ],
       [ 0.39553605, -0.20444521, -0.89540683]])), (np.array([ 0.06560817,  0.36912371, -0.85827754]), array([[ 0.9713231 ,  0.        , -0.2377634 ],
